...
//
// Targets the same tag schema as gemini.js extractPostTags():
 ...
 *
 * Returns the same object shape as gemini.js extractPostTags(), so it can be
 * stored directly as post.tags without any other changes to the pipeline.
 *
